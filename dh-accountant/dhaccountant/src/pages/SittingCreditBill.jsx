  ...
  const getPatBills = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/getSittingBillDue/${branch}`,
        {
          headers: {
  ...
  const updateBillforSitting = async (id) => {
    ...
    try {
      const res = await axios.put(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/updateSittingBillToPaid/${id}/${branch}`,
        billUpdateForm,
        {
          headers: {
            "Content-Type": "application/json",
