  ...
  const getDrugsData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/getDrugs/${branch.name}`,
        {
          headers: {
  ...
  const addDrugData = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/addDrugs",
        addDrugs,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const updateDrugDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/updateDrugDetails/${selected}`,
        upaAddDrugs,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteDrug = async (id) => {
    try {
      const response = await axios.delete(
        `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/deleteDrug/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
