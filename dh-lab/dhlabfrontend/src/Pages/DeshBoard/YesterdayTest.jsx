    ...
    const fetchYesterdayTest = async () => {
      try {
        const response = await axios.get(
          "https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/get-patient-test-details"
        );
        const yesterday = new Date();
        yesterday.setDate(yesterday.getDate() - 1);
        const yesterdayTests = response.data.filter(
          (test) =>
            new Date(test.created_date).toDateString() ===
