...
function CancleAppointment({ onClose, appointmentInfo, allAppointmentData }) {
  ...
  const handleCancelAppointment = async (e) => {
    ...
    const newAppointment = {
      ...
      status: "Cancel",
      payment_Status:
        data.payment_Status == "paid" ? "Refund" : data.payment_Status,
    ...
    //     await axios.put(`https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/cancel-appointment-status-opd`, newAppointment);
    ...
    try {
      ...
      const response = await axios.put(
        "https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/cancel-appointment-status-opd",
        newAppointment,
        {
          headers: {
            "Content-Type": "application/json",
                  ...
                  data.payment_Status == "paid" && (
                    <div class="mb-3">
                      ...
                      <input
                        type="text"
                        value={
                          data?.payment_Status == "paid" ? data?.opd_amount : 0
                        }
                        readOnly
                        class="form-control"
                        name="opd_amount"
