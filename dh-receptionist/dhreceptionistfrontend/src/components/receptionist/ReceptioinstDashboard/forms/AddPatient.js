...
function AddPatient() {
  ...
  const getInsuranceCompany = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getInsuranceCompany/${branch}`
      );
  ...
  const getDisease = async () => {
    try {
      const response = await axios.get(
        "https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-disease"
      );
      console.log(response);
  ...
  const handleSubmit = async (e) => {
    ...
    if (isSlotAvailable) {
      ...
      try {
        setLoading(true);
        const response = await axios.post(
          "https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/add-patient",
          newPatient,
          {
            headers: {
              "Content-Type": "application/json",
