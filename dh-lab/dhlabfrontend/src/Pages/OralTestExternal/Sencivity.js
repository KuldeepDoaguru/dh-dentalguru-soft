  ...
  const hundleSumbit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/paitent-test/${patientbill_no}`,
        {
          test: patienttest,
          ...
          <div className="container-fluid">
                      ...
                      <tr className="table-row">
                        <td className="table-small" style={{ width: "20%" }}>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setPatientbranch_name(e.target.value)
                            }
                          />
                        </td>
                      </tr>
            ...
            <div className="container-fluid">
              <div className="row d-print-none">
                <div className="d-flex justify-content-between">
                  <div className="col-lg-4 form-group">
                    <label className="fw-bold fs-5">Test (Methodology)</label>
                    <input
                      list="TestName"
                      className="form-control mt-2 p-3"
                      name="test"
