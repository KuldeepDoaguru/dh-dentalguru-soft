...
const PaymentTest = () => {
  ...
  //   try {
  //     const response = await axios.post(`https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/patient-test-payment/${id}`, {
  ...
  const handlePayButtonClick = async () => {
    try {
      setLoading(true);
      const response = await axios.post(
        `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/patient-test-payment/${id}`,
        {
          patient_uhid: patientUHID,
          patient_name: patientName,
          payment: patientcost,
        ...
        <div className="main">
          <div className="container-fluid">
            <div className="row flex-nowrap ">
              ...
              <div
                className="col-xxl-11 col-xl-11 col-lg-11 col-md-11 col-sm-11 p-0"
                      ...
                      <button
                        ...
                        onClick={() =>
                          navigate(`/oral-testing/${id}`, {
                            state: { test: patienttest, cost: patientcost },
                          })
                        }
                      >
                        Go Test
