...
const BranchInfo = () => {
  ...
  const getBranchDetail = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/get-branch-detail/${branch}`,
        {
          headers: {
  ...
  const getBranchHolidays = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/get-branch-holidays/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
    ...
    <>
      <Wrapper>
        ...
        <div className="row mrgnzero">
          ...
          >
            <div
              className="container-fluid  shadow p-3 mt-5 bg-body rounded"
              style={{ width: "98%" }}
            >
            ...
            <div className="col-lg-12">
              <div
                className="widget-area-2 proclinic-box-shadow  mt-5 mx-3"
                id="tableres"
              >
