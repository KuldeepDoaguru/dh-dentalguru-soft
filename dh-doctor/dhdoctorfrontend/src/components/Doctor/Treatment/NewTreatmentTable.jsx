...
const NewTreatmentTable = () => {
  ...
  const fetchTreatmentData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalhouse-doctor.vimubds5.a2hosted.com/api/doctor/getTreatmentDataViaBranchAndTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const updateAppointmentStat = async () => {
    try {
      const res = await axios.put(
        `https://dentalhouse-doctor.vimubds5.a2hosted.com/api/doctor/updateAppointStatus/${appoint_id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const generateFinalBill = async () => {
    ...
    try {
      const res = await axios.post(
        "https://dentalhouse-doctor.vimubds5.a2hosted.com/api/doctor/generateFinalBillwithTpid",
        billInputField,
        {
          headers: {
            "Content-Type": "application/json",
