...
const Accountant_Dashboard = () => {
  ...
  const getTodaysBill = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/getBillsByBranch/${user.branch}`,
        {
          headers: {
  ...
  const getPatBills = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/getSittingBillDue/${user.branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
