...
const PasswordReset = () => {
  ...
  //       "https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/sendOtp",
  //       {
  //         email,
  //       }
  //     );
  ...
  const verifyOtpAdmin = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/verifyOtp",
        {
          email,
          otp,
        }
  ...
  const changePassword = async (e) => {
    ...
    try {
      const response = await axios.put(
        "https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/resetPassword",
        {
          email,
