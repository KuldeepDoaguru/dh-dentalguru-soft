...
//       const responsee = await axios.put(`https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/update-test-status/${id}`, [],
//         {
//           headers: {
//             'Content-Type': 'application/json',
//             'Authorization': `Bearer ${token}`
...
//         `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/update-patent-test-data/${patientbill_no}`,
//         formData,
//         {
//           headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const responsee = await axios.put(
        `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/update-test-status/${id}`,
        [],
        {
          headers: {
            "Content-Type": "application/json",
