  ...
  const getDocDetailsList = async () => {
    try {
      ...
      const { data } = await axios.get(
        `https://dentalhouse-admin.vimubds5.a2hosted.com//api/v1/admin/getEmployeeDataByBranch/${branch}`,
        {
          headers: {
  ...
  const enrollEmployeeDetails = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://dentalhouse-admin.vimubds5.a2hosted.com//api/v1/admin/enroll-employee",
        formData,
        {
          headers: {
  ...
  const addEmployeeTimeline = async () => {
    try {
      ...
      const response = await axios.post(
        `https://dentalhouse-admin.vimubds5.a2hosted.com//api/v1/admin/addSuperAdminNotify`,
        {
          branch_name: branch,
