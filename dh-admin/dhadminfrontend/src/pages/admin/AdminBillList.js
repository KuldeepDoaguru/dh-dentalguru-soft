...
const AdminBillList = () => {
  ...
  const getBillDetailsList = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalhouse-admin.vimubds5.a2hosted.com//api/v1/admin/getBillsByBranch/${user.branch_name}`,
        {
          headers: {
  ...
  const deleteBillData = async (id) => {
    try {
      const response = await axios.delete(
        `https://dentalhouse-admin.vimubds5.a2hosted.com//api/v1/admin/deleteBills/${id}`,
        {
          headers: {
            "Content-Type": "multipart/form-data",
            Authorization: `Bearer ${user.token}`,
  ...
  const getBillDetailsByBid = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalhouse-admin.vimubds5.a2hosted.com//api/v1/admin/getBillBYBillId/${selectedItem}`,
        {
          headers: {
            "Content-Type": "multipart/form-data",
            Authorization: `Bearer ${user.token}`,
  ...
  const updateBillDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalhouse-admin.vimubds5.a2hosted.com//api/v1/admin/updateBillDetailsByBillId/${selectedItem}`,
        upData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
