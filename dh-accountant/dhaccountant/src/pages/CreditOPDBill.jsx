  ...
  const getAppointments = async () => {
    ...
    try {
      const response = await axios.get(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/get-appointments/${branch}`,
        {
          headers: {
  ...
  const updateBillforPaid = async (id) => {
    ...
    try {
      const res = await axios.put(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/ChangeStatusToPaidOPDBill/${id}/${branch}`,
        {},
        {
          headers: {
            "Content-Type": "application/json",
