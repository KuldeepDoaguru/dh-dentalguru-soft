...
const FinancialReportCard = () => {
  ...
  const getPurchaseList = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/getPurInventoryByBranch/${branch.name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const downloadEarningData = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/downloadEarnReportByTime/${branch.name}`,
  ...
  //   try {
  //     const { data } = await axios.post(
  //       `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/downloadExpenseReportByTime/${branch.name}`,
