...
const PatintDuePaymentPrint = () => {
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/getPatientBillsAndSecurityAmountByBranch/${user.branch}/${bid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getPatientDetailsByBill = async () => {
    try {
      const response = axios.get(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/getPatientDetailsForBill/${user.branch}/${uhid}/${bid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const makePayment = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.put(
        `https://dentalhouse-accountant.vimubds5.a2hosted.com/api/v2/accountant/makeBillPayment/${user.branch}/${bid}`,
        {
