...
function BookAppointment() {
  ...
  const getBranchDetail = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-branch-detail/${branch}`
      );
  ...
  const getBranchHolidays = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-branch-holidays/${branch}`,
        {
          headers: {
  ...
  const getPatientTreatmentDetails = async (uhid) => {
    try {
      const response = await axios.get(
        `https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getPatientDeatilsByUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getPatient = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-Patients/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getTreatment = async () => {
    try {
      const response = await axios.get(
        "https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-treatments"
      );
      console.log(response);
  ...
  const getDoctors = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-doctors/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getDoctorsWithLeave = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-doctors-with-leave/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const timelineData = async (id) => {
    try {
      const response = await axios.post(
        "https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/insertTimelineEvent",
        {
          type: "Appointment",
  ...
  const handleBookAppointment = async (e) => {
    ...
    if (isSlotAvailable) {
      ...
      try {
        setLoading(true);
        const response = await axios.post(
          "https://dentalhouse-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/book-appointment",
          newAppointment,
          {
            headers: {
              "Content-Type": "application/json",
            ...
            <div className="row mt-5">
                  ...
                  <div className="col-sm-6 ">
                    <div className="form-outline">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          selectedPatient ? selectedPatient?.credit_By : ""
                        }
                        className="form-control"
                        onChange={handleDateChange}
                        readOnly
                  ...
                  <div className="col-sm-6 ">
                    <div className="form-outline">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          selectedPatient ? selectedPatient?.beneficiary_Id : ""
                        }
                        className="form-control"
                        onChange={handleDateChange}
                        readOnly
              ...
              {selectedTreatment === "OPD" && (
                <>
                  ...
                  {(bookData.payment_Mode === "Card" ||
                    bookData.payment_Mode === "UPI") && (
                    <div className="col-sm-6">
                      <div className="form-outline">
