  ...
  const enrollEmployeeDetails = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/enroll-employee",
        formData,
        {
          headers: {
  ...
  const addEmployeeTimeline = async () => {
    try {
      const response = await axios.post(
        `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/addSuperAdminNotify`,
        {
  ...
  const editEmployeeData = async (eid) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalhouse-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/editEmployeeDetails/${branch.name}/${eid}`,
        { status: "Approved" },
        {
          headers: {
            "Content-Type": "multipart/form-data",
