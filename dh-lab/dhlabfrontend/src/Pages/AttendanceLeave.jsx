...
const AttendanceLeave = () => {
  ...
  const getAttendance = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/getAttendancebyempId/${branch}/${employeeId}`,
        {
          headers: {
  ...
  const getLeaves = async () => {
    try {
      const response = await axios.get(
        `https://dentalhouse.lab.vimubds5.a2hosted.com/api/lab/get-leaves/${branch}/${employeeId}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
